...
module ActiveworldsFFI
  ...
  AW_XFER_DISCONNECT_REASON = 463
  AW_XFER_TYPE = 464
  AW_XFER_FROM_SESSION = 465
  AW_XFER_FROM_NAME = 466
  AW_XFER_TO_SESSION = 467
  AW_XFER_TO_NAME = 468
  AW_XFER_TO_WORLD_NAME = 469
  AW_WORLD_GROUND = 47
  AW_XFER_TO_ZONE_NAME = 470
  AW_XFER_TO_TAG_NAME = 471
  AW_XFER_DATA_ID = 472
  AW_XFER_DATA_FILE_NAME = 473
  AW_XFER_DATA_LEN_TOTAL = 474
  AW_XFER_DATA_LEN_OFFSET = 475
  AW_XFER_DATA = 476
  AW_XFER_DATA2 = 477
  AW_XFER_DATA3 = 478
  AW_XFER_DATA_MORE = 479
  AW_WORLD_OBJECT_PATH = 48
  AW_XFER_RC = 480
  AW_XFER_SHOW_NAME = 481
  AW_XFER_OPTIONS = 482
  AW_XFER_EXPIRATION = 483
  AW_LICENSE_XFER_SHOW_RIGHTS = 484
  AW_XFER_SHOW_CAPABILITY = 485
  AW_XFER_SHOW_SEQUENCE = 486
  AW_LASER_BEAM_SOURCE_TYPE = 487
  AW_LASER_BEAM_SOURCE_ID = 488
  AW_LASER_BEAM_SOURCE_X = 489
  AW_WORLD_OBJECT_REFRESH = 49
  AW_LASER_BEAM_SOURCE_Y = 490
  AW_LASER_BEAM_SOURCE_Z = 491
  AW_LASER_BEAM_TARGET_TYPE = 492
  AW_LASER_BEAM_TARGET_ID = 493
  AW_LASER_BEAM_TARGET_X = 494
  AW_LASER_BEAM_TARGET_Y = 495
  AW_LASER_BEAM_TARGET_Z = 496
  AW_LASER_BEAM_STYLE = 497
  AW_LASER_BEAM_COLOR = 498
  AW_LASER_BEAM_DEFINITION = 499
  AW_LOGIN_PRIVILEGE_NAME = 5
  AW_WORLD_BUILD_RIGHT = 50
  AW_WORLD_VOIPCAST_HOST = 500
  AW_WORLD_VOIPCAST_PORT = 501
  AW_MY_ZONE = 502
  AW_AVATAR_ZONE = 503
  AW_MAX_ATTRIBUTE = 504
  ...
  enum :AW_ATTRIBUTE, [  :AW_LOGIN_NAME, 0,
  :AW_LOGIN_PASSWORD, 1,
  :AW_UNIVERSE_BROWSER_BETA, 10,
  :AW_WORLD_SKYBOX, 100,
  :AW_WORLD_MINIMUM_VISIBILITY, 101,
  ...
  AW_EVENT_XFER_DISCONNECT = 53
  AW_EVENT_XFER_OFFER = 54
  AW_EVENT_XFER_REPLY = 55
  AW_EVENT_XFER_SEND = 56
  AW_EVENT_XFER_REQUEST = 57
  AW_EVENT_XFER_CANCEL = 58
  AW_EVENT_LASER_BEAM = 59
  AW_EVENT_CHAT = 6
  AW_MAX_EVENT = 60
  ...
  enum :AW_EVENT_ATTRIBUTE, [  :AW_EVENT_AVATAR_ADD, 0,
  :AW_EVENT_AVATAR_CHANGE, 1,
  :AW_EVENT_UNIVERSE_DISCONNECT, 10,
  :AW_EVENT_WORLD_ATTRIBUTES, 11,
  :AW_EVENT_WORLD_INFO, 12,
  ...
  AW_CALLBACK_XFER_LOGIN = 44
  AW_CALLBACK_XFER_REQUEST_SHOW_REPLY = 45
  AW_MAX_CALLBACK = 46
  ...
  enum :AW_CALLBACK, [  :AW_CALLBACK_CREATE, 0,
  :AW_CALLBACK_LOGIN, 1,
  :AW_CALLBACK_SEND_FILE, 10,
  :AW_CALLBACK_JOIN, 11,
  :AW_CALLBACK_PASSWORD_SEND, 12,
  ...
  enum :AW_CHAT_TYPES, [  :AW_CHAT_SAID, 0,
  :AW_CHAT_BROADCAST, 1,
  :AW_CHAT_WHISPER, 2  ]
  ...
  enum :AW_CONTACT_STATES, [  :AW_CONTACT_OFFLINE, 0,
  :AW_CONTACT_ONLINE, 1,
  :AW_CONTACT_NOT_A_CITIZEN, 2,
  :AW_CONTACT_AFK, 3,
  :AW_CONTACT_UNKNOWN, 4,
  ...
  enum :AW_WORLD_STATES, [  :AW_WORLDSTATUS_UNKNOWN, 0,
  :AW_WORLDSTATUS_PUBLIC, 1,
  :AW_WORLDSTATUS_PRIVATE, 2,
  :AW_WORLDSTATUS_STOPPED, 3  ]
  ...
  enum :AW_SERVER_STATES, [  :AW_SERVER_STOPPED, 0,
  :AW_SERVER_STARTING, 1,
  :AW_SERVER_START_WAIT, 2,
  :AW_SERVER_RUNNING, 3  ]
  ...
  enum :AW_CONNECTION_TYPES, [  :AW_CONNECTION_DIRECT, 0,
  :AW_CONNECTION_FIREWALL_NO_PROXY, 1,
  :AW_CONNECTION_PROXY_AUTO, 2,
  :AW_CONNECTION_PROXY_NO_AUTH, 3,
  :AW_CONNECTION_PROXY_BASIC, 4,
  ...
  enum :AW_CONNECTION_STATES, [  :AW_CONNECTION_STATE_NOT_CONNECTED, 0,
  :AW_CONNECTION_STATE_CONNECTING_TO_PROXY, 1,
  :AW_CONNECTION_STATE_NEGOTIATING_WITH_PROXY, 2,
  :AW_CONNECTION_STATE_CONNECTING_TO_TUNNEL, 3,
  :AW_CONNECTION_STATE_CONNECTING_TO_UNIVERSE, 4,
  ...
  enum :AW_EJECTION_TYPES, [  :AW_EJECT_BY_ADDRESS, 0,
  :AW_EJECT_BY_COMPUTER, 1,
  :AW_EJECT_BY_CITIZEN, 2  ]
  ...
  enum :AW_AVATAR_STATES, [  :AW_AVATAR_STATE_WALKING, 0,
  :AW_AVATAR_STATE_RUNNING, 1,
  :AW_AVATAR_STATE_SLIDING3, 10,
  :AW_AVATAR_STATE_CLIMBING, 11,
  :AW_AVATAR_STATE_FLYING, 2,
  ...
  enum :AW_ZONE_TYPES, [  :AW_ZONE_TYPE_CUBE, 0,
  :AW_ZONE_TYPE_CYLINDER, 1,
  :AW_ZONE_TYPE_SPHERE, 2  ]
  ...
  enum :AW_PARTICLE_TYPES, [  :AW_PARTICLE_TYPE_SPRITE, 0,
  :AW_PARTICLE_TYPE_FACER, 1,
  :AW_PARTICLE_TYPE_FLAT, 2,
  :AW_PARTICLE_TYPE_OBJECT, 3  ]
  ...
  enum :AW_PARTICLE_DRAW_STYLES, [  :AW_PARTICLE_DRAW_NORMAL, 0,
  :AW_PARTICLE_DRAW_BRIGHT, 1,
  :AW_PARTICLE_DRAW_GLOW, 2  ]
  ...
  AW_CAMERA_TRACK_SELF_FIRST_PERSON = 4
  AW_CAMERA_TRACK_SELF_LOCKED = 5
  AW_CAMERA_TRACK_SELF_CHASE = 6
  AW_CAMERA_TRACK_SELF_FRONT = 7
  ...
  enum :AW_CAMERA_TYPES, [  :AW_CAMERA_TRACK_DEFAULT, 0,
  :AW_CAMERA_TRACK_AVATAR, 1,
  :AW_CAMERA_TRACK_OBJECT, 2,
  :AW_CAMERA_TRACK_AHEAD, 3,
  :AW_CAMERA_TRACK_SELF_FIRST_PERSON, 4,
  ...
  enum :AW_REGISTER_METHODS, [  :AW_REGISTER_MONTHLY, 0,
  :AW_REGISTER_ANNUAL, 1,
  :AW_REGISTER_USER, 2  ]
  ...
  enum :AW_AVATAR_SET_FLAGS, [  :AW_AVATAR_SET_NONE, 0x00,
  :AW_AVATAR_SET_POSITION, 0x01,
  :AW_AVATAR_SET_TYPE, 0x02,
  :AW_AVATAR_SET_GESTURE, 0x04,
  :AW_AVATAR_SET_STATE, 0x08  ]
  ...
  enum :AW_ENTITY_TYPES, [  :AW_ENTITY_AVATAR, 0,
  :AW_ENTITY_MOVER, 1  ]
  ...
  enum :AW_MOVER_STATE_TYPES, [  :AW_MOVER_STATE_IDLE, 0,
  :AW_MOVER_STATE_START, 1,
  :AW_MOVER_STATE_MOVE, 2,
  :AW_MOVER_STATE_PAUSE, 3,
  :AW_MOVER_STATE_CONTINUE, 4,
  ...
  enum :AW_MOVER_FLAGS, [  :AW_MOVER_FLAG_LOOP, 0x00000001,
  :AW_MOVER_FLAG_USE_OBJTAG, 0x00000002,
  :AW_MOVER_FLAG_BUMP_ADD, 0x00000004,
  :AW_MOVER_FLAG_CLICK_START, 0x00000008,
  :AW_MOVER_FLAG_CLICK_PAUSE, 0x00000010,
  ...
  enum :AW_MOVER_TYPES, [  :AW_MOVER_TYPE_PASSIVE, 0,
  :AW_MOVER_TYPE_ACTIVE, 1,
  :AW_MOVER_TYPE_ITEM, 2  ]
  ...
  enum :AW_ZONE_FLAGS, [  :AW_ZONE_FLAG_WATER, 0x01,
  :AW_ZONE_FLAG_BLOCK_PARTICLES, 0x02,
  :AW_ZONE_FLAG_BLOCK_LIGHTS, 0x04,
  :AW_ZONE_FLAG_BLOCK_WORLD_LIGHT, 0x08,
  :AW_ZONE_FLAG_BLOCK_CHAT, 0x10,
  ...
  enum :AW_PARTICLE_FLAGS, [  :AW_PARTICLE_FLAG_INTERPOLATE, 0x01,
  :AW_PARTICLE_FLAG_GRAVITY, 0x02,
  :AW_PARTICLE_FLAG_COLLIDE_ZONES, 0x04,
  :AW_PARTICLE_FLAG_ZONE_EXCLUSIVE, 0x08,
  :AW_PARTICLE_FLAG_CAMERA_EMIT, 0x10,
  ...
  enum :AW_CAMERA_FLAGS, [  :AW_CAMERA_FLAG_TRACK_USER, 0x01  ]
  ...
  enum :AW_OBJECT_TYPES, [  :AW_OBJECT_TYPE_V3, 0,
  :AW_OBJECT_TYPE_UNKNOWN, 1,
  :AW_OBJECT_TYPE_ZONE, 2,
  :AW_OBJECT_TYPE_PARTICLES, 3,
  :AW_OBJECT_TYPE_MOVER, 4,
  ...
  enum :AW_HUD_ORIGIN_TYPES, [  :AW_HUD_ORIGIN_TOP_LEFT, 0,
  :AW_HUD_ORIGIN_TOP, 1,
  :AW_HUD_ORIGIN_TOP_RIGHT, 2,
  :AW_HUD_ORIGIN_LEFT, 3,
  :AW_HUD_ORIGIN_CENTER, 4,
  ...
  enum :AW_HUD_TYPES, [  :AW_HUD_TYPE_TEXT, 0,
  :AW_HUD_TYPE_IMAGE, 1,
  :AW_HUD_TYPE_MODEL, 2  ]
  ...
  enum :AW_HUD_ELEMENT_FLAGS_ENUM, [  :AW_HUD_ELEMENT_FLAG_CLICKS, 0x0001,
  :AW_HUD_ELEMENT_FLAG_STRETCH, 0x0002,
  :AW_HUD_ELEMENT_FLAG_ADDITIVE, 0x0004,
  :AW_HUD_ELEMENT_FLAG_SIZE_PERCENT, 0x0008,
  :AW_HUD_ELEMENT_FLAG_TRANSITION, 0x0010,
  ...
  enum :AW_PRIVACY_TYPES, [  :AW_PRIVACY_BLOCK_TELEGRAMS, 0x0001  ]
  ...
  enum :AW_ENABLE_CAV_TYPES, [  :AW_ENABLE_CAV_CITIZEN, 0x01,
  :AW_ENABLE_CAV_BOT, 0x02,
  :AW_ENABLE_CAV_TOURIST, 0x04,
  :AW_ENABLE_CAV_WORLD_CITIZEN, 0x10,
  :AW_ENABLE_CAV_WORLD_BOT, 0x20,
  ...
  enum :AW_XFER_TYPES, [  :AW_XFER_TYPE_FILE, 0,
  :AW_XFER_TYPE_IMAGE, 1,
  :AW_XFER_TYPE_DOCUMENT, 2,
  :AW_XFER_TYPE_MEDIA, 3  ]
  ...
  AW_LASER_BEAM_SOURCE_TYPES_ENUM = {
    :AW_LASER_BEAM_SOURCE_TYPE_NONE => 0,
    :AW_LASER_BEAM_SOURCE_TYPE_AVATAR => 1,
    :AW_LASER_BEAM_SOURCE_TYPE_OBJECT => 2,
    :AW_LASER_BEAM_SOURCE_TYPE_COORDS => 3,
  }
  enum :AW_LASER_BEAM_SOURCE_TYPES, [  :AW_LASER_BEAM_SOURCE_TYPE_NONE, 0,
  :AW_LASER_BEAM_SOURCE_TYPE_AVATAR, 1,
  :AW_LASER_BEAM_SOURCE_TYPE_OBJECT, 2,
  :AW_LASER_BEAM_SOURCE_TYPE_COORDS, 3  ]
  ...
  AW_LASER_BEAM_TARGET_TYPES_ENUM = {
    :AW_LASER_BEAM_TARGET_TYPE_NONE => 0,
    :AW_LASER_BEAM_TARGET_TYPE_AVATAR => 1,
    :AW_LASER_BEAM_TARGET_TYPE_OBJECT => 2,
    :AW_LASER_BEAM_TARGET_TYPE_COORDS => 3,
  }
  enum :AW_LASER_BEAM_TARGET_TYPES, [  :AW_LASER_BEAM_TARGET_TYPE_NONE, 0,
  :AW_LASER_BEAM_TARGET_TYPE_AVATAR, 1,
  :AW_LASER_BEAM_TARGET_TYPE_OBJECT, 2,
  :AW_LASER_BEAM_TARGET_TYPE_COORDS, 3  ]
  ...
  AW_LASER_BEAM_STYLES_ENUM = {
    :AW_LASER_BEAM_STYLE_LINE => 0,
    :AW_LASER_BEAM_STYLE_PARTICLE => 1,
  }
  enum :AW_LASER_BEAM_STYLES, [  :AW_LASER_BEAM_STYLE_LINE, 0,
  :AW_LASER_BEAM_STYLE_PARTICLE, 1  ]
  ...
  attach_function :aw_createW, [ :pointer, :int, :pointer ], :int
  ...
  attach_function :aw_stringW, [ :int ], :pointer
  attach_function :aw_string, [ :int ], :string
  attach_function :aw_string_set, [ :int, :string ], :int
  attach_function :aw_string_setW, [ :int, :pointer ], :int
  ...
  attach_function :aw_license_attributesW, [ :pointer ], :int
  attach_function :aw_license_change, [  ], :int
  attach_function :aw_license_delete, [ :string ], :int
  attach_function :aw_license_deleteW, [ :pointer ], :int
  ...
  attach_function :aw_url_sendW, [ :int, :pointer, :pointer ], :int
  attach_function :aw_url_click, [ :string ], :int
  attach_function :aw_url_clickW, [ :pointer ], :int
  ...
  attach_function :aw_world_attribute_setW, [ :int, :pointer ], :int
  attach_function :aw_world_attribute_get, [ :int, :pointer, :string ], :int
  attach_function :aw_world_attribute_getW, [ :int, :pointer, :pointer ], :int
  ...
  attach_function :aw_avatar_locationW, [ :int, :int, :pointer ], :int
  ...
  attach_function :aw_laser_beam, [  ], :int
  attach_function :aw_tick, [  ], :uint
  attach_function :aw_check_right, [ :int, :string ], :int
  attach_function :aw_check_rightW, [ :int, :pointer ], :int
  attach_function :aw_check_right_all, [ :string ], :int
  attach_function :aw_check_right_allW, [ :pointer ], :int
  ...
  attach_function :aw_string_to_unicode, [ :string ], :pointer
  attach_function :aw_string_from_unicode, [ :pointer ], :string
  attach_function :aw_string_set_MBCS_codepage, [ :uint ], :void
  attach_function :aw_server_admin, [ :string, :int, :string, :pointer ], :int
  attach_function :aw_server_adminW, [ :pointer, :int, :pointer, :pointer ], :int
  ...
  # attach_function :aw_contact_add_by_nameW, [ :pointer, :uint ], :int
  ...
  attach_function :aw_telegram_sendW, [ :pointer, :pointer ], :int
  ...
  attach_function :aw_voip_group_setW, [ :int, :pointer ], :int
  # attach_function :aw_voipcast_set, [ :string, :ushort ], :int
  # attach_function :aw_voipcast_setW, [ :pointer, :ushort ], :int
  # attach_function :aw_voipcast_set_resolved, [ :ulong, :ushort ], :int
  # attach_function :aw_voipcast_ready, [  ], :int
  attach_function :aw_debug_callback_set, [ callback([ :string ], :void) ], :int
  attach_function :aw_xfer_offer, [  ], :int
  attach_function :aw_xfer_reply, [  ], :int
  attach_function :aw_xfer_send, [  ], :int
  attach_function :aw_xfer_request, [  ], :int
  attach_function :aw_xfer_request_show, [ :string, :int, :string, :string, :string ], :int
  attach_function :aw_xfer_request_showW, [ :pointer, :int, :pointer, :pointer, :pointer ], :int
  attach_function :aw_xfer_cancel, [  ], :int
