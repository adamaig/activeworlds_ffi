...
Gem::Specification.new do |s|
  ...
  s.files = Dir['utils/**/*.rb'] + Dir['lib/**/*.rb'] + Dir['examples/**/*'] + ["History.txt", "README.txt", "LICENSE", "PostInstall.txt", "activeworlds_ffi.gemspec"]
  s.has_rdoc = true
  s.homepage = %q{http://github.com/adamaig/activeworlds_ffi}
